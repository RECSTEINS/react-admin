...
import InvoicesOutlined from "@mui/icons-material/ReceiptOutlined";
...
const SidebarR = () => {
    ...
    return(
        <Box sx={{
            ...
            "& .pro-inner-item":{
                paddin: "5px 35px 5px 20px !important"
            },
        ...
        >
            <Sidebar collapsed={isCollapsed} backgroundColor={colors.grey[600]}>
                    ...
                    {!isCollapsed && (
                        <Box mb="25px">
                            ...
                            <Box textAlign="center">
                                <Typography variant="h2" color={colors.grey[100]} fontWeight="bold" sx={{ m: "10px 0 0 0"}}>Raúl</Typography>
